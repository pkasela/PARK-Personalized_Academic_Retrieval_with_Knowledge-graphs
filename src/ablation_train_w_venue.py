...
from dataloader.ablation_dataloader import UserVenueAuthorGraphDataLoader, user_venue_author_collate_fn
from model.ablation_model import UserVenueGraphTransX
from loss.ablation_loss import UserVenueTransXLoss
...
def main(dataset_folder, dataset_name, model_save_name, shuffle, batch_size, lr, n_relations, trans_mode, device, max_epoch, embeddings_folder, model_dir):
    ...
    torch.save(model.state_dict(), os.path.join(model_dir, dataset_name, trans_mode, 'user_venue.pt'))
